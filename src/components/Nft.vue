<template>
  <div id="card">
    <div id="image-nft">
      <img src="../assets/img/image-equilibrium.jpg" alt="sss">
      <div id="hover-nft">
        <img src="./icons/icon-view.svg" alt="view" />
      </div>
    </div>
